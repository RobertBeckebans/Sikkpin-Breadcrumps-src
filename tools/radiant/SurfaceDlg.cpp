...
void CSurfaceDlg::SetTexMods( void ) {
	UpdateData( TRUE );
...
BOOL CSurfaceDlg::OnInitDialog( void ) {
...
void CSurfaceDlg::OnClose( void ) {
	g_surfwin = NULL;
	CDialog::OnClose();
}

void CSurfaceDlg::OnCancel( void ) {
	if ( g_bGatewayhack )  {
		OnOK();
	} else  {
		OnBtnCancel();
...
void CSurfaceDlg::OnDestroy( void ) {
	if ( GetSafeHwnd() ) {
		CRect rct;
		GetWindowRect( rct );
...
void CSurfaceDlg::OnBtnCancel( void ) {
...
void CSurfaceDlg::OnBtnColor( void ) {
}
...
void CSurfaceDlg::OnBtnPatchdetails( void ) {
	Patch_NaturalizeSelected( true );
	g_pParentWnd->GetCamera()->MarkWorldDirty();
	Sys_UpdateWindows( W_ALL );
}

void CSurfaceDlg::OnBtnPatchnatural( void ) {
...
void CSurfaceDlg::OnBtnPatchreset( void ) {
	//CTextureLayout dlg;
	//if (dlg.DoModal() == IDOK) {
...
void CSurfaceDlg::OnBtnAxial( void ) {
}

void CSurfaceDlg::OnBtnBrushfit( void ) {
	// TODO: Add your control notification handler code here
}

void CSurfaceDlg::OnBtnFacefit( void ) {
	UpdateData( TRUE );
/*
	brush_t *b;
...
void CSurfaceDlg::OnCheckSubdivide( void ) {
	UpdateData( TRUE );
...
void CSurfaceDlg::OnChangeEditHorz( void ) {
...
void CSurfaceDlg::OnChangeEditVert( void ) {
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
	// with the ENM_CHANGE flag ORed into the mask.
...
void CSurfaceDlg::OnSetfocusHscale( void ) {
	focusControl = &m_wndHScale;	
}

void CSurfaceDlg::OnKillfocusHscale( void ) {
	focusControl = NULL;
}

void CSurfaceDlg::OnKillfocusVscale( void ) {
	focusControl = NULL;
}

void CSurfaceDlg::OnSetfocusVscale( void ) {
	focusControl = &m_wndVScale;	
}

void CSurfaceDlg::OnKillfocusEditWidth( void ) {
	focusControl = NULL;
}

void CSurfaceDlg::OnSetfocusEditWidth( void ) {
	focusControl = &m_wndWidth;	
}

void CSurfaceDlg::OnKillfocusEditHeight( void ) {
	focusControl = NULL;
}

void CSurfaceDlg::OnSetfocusEditHeight( void ) {
	focusControl = &m_wndHeight;	
}

void CSurfaceDlg::OnBtnFlipx( void ) {
	Select_FlipTexture( false );
}

void CSurfaceDlg::OnBtnFlipy( void ) {
	Select_FlipTexture( true );
}

void CSurfaceDlg::OnKillfocusRotate( void ) {
	focusControl = NULL;
}

void CSurfaceDlg::OnSetfocusRotate( void ) {
	focusControl = &m_wndRotateEdit;
}

void CSurfaceDlg::OnEnChangeVshift( void ) {
	// TODO:  If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
	// with the ENM_CHANGE flag ORed into the mask.
...
// ---> sikk - Merged Patch Inspector into Surface Inspector
void CSurfaceDlg::OnBtnPatchfit( void ) {
// sikk - I don't think this should be done
//	Select_SetTexture( &g_qeglobals.d_texturewin.texdef, &g_qeglobals.d_texturewin.brushprimit_texdef, false );
...
void CSurfaceDlg::OnSelchangeComboCol( void ) {
	UpdateRowColInfo();
}
...
void CSurfaceDlg::OnSelchangeComboType( void ) {
	// TODO: Add your control notification handler code here
}
...
void CSurfaceDlg::SetPatchInfo( void ) {
}

void DoPatchInspector( void ) {
...
void CSurfaceDlg::UpdateRowColInfo( void ) {
...
void CSurfaceDlg::UpdateInfo( void ) {
	GetPatchInfo();
}
