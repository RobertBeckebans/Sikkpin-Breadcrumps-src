...
================
*/
void CCamWnd::Cam_BuildMatrix( void ) {
	float	xa, ya;
	float	matrix[4][4];
	int		i;
...
================
*/
void CCamWnd::Cam_PositionDrag( void ) {
	int x, y;
...
==================
*/
void CCamWnd::Cam_PositionRotate( void ) {
	int		x, y, i;
...
==================
*/
void CCamWnd::Cam_MouseLook( void ) {
	CPoint current;
	GetCursorPos( &current );
	if ( current.x != m_ptCursor.x || current.y != m_ptCursor.y ) {
		SetCursor( NULL ); // sikk - Remove Cursor
...
==================
*/
void CCamWnd::Cam_MouseControl( void ) {
...
==================
*/
void CCamWnd::SetProjectionMatrix( void ) {
	float xfov = 90;
...
==================
*/
void CCamWnd::Cam_DrawMapBounds( void ) {
	qglBlendFunc( GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA );
	qglEnable( GL_BLEND );
...
==================
*/
void CCamWnd::Cam_DrawWorldAxis( void ) {
...
==================
*/
void CCamWnd::Cam_DrawCameraAxis( void ) {
...
==================
*/
void CCamWnd::Cam_DrawClipPoints( void ) {
	qglEnable( GL_DEPTH_TEST );
	qglPointSize( 8 );
...
=================
*/
void CCamWnd::BuildRendererState( void ) {
...
==================
*/
bool CCamWnd::UpdateRenderEntities( void ) {
	if ( rebuildMode ) {
		return false;
	}
...
==================
*/
void CCamWnd::FreeRendererState( void ) {
	for ( entity_t *ent = entities.next; ent != &entities; ent = ent->next ) {
		if ( ent->lightDef >= 0 ) {
			g_qeglobals.rw->FreeLightDef( ent->lightDef );
			ent->lightDef = -1;
...
==================
*/
void CCamWnd::UpdateCaption( void ) {
	idStr strCaption;
...
==================
*/
void CCamWnd::ToggleRenderMode( void ) {
	renderMode ^= 1;
	UpdateCaption();
}
...
==================
*/
void CCamWnd::ToggleRebuildMode( void ) {
	rebuildMode ^= 1;
	UpdateCaption();
}
...
==================
*/
void CCamWnd::ToggleEntityMode( void ) {
	entityMode ^= 1;
	UpdateCaption();
}
...
==================
*/
void CCamWnd::ToggleAnimationMode( void ) {
	animationMode ^= 1;
	if ( animationMode )  {
		SetTimer( 0, 10, NULL );
	} else {
...
==================
*/
void CCamWnd::ToggleSoundMode( void ) {
	soundMode ^= 1;
...
==================
*/
void CCamWnd::ToggleSelectMode( void ) {
	selectMode ^= 1;
	UpdateCaption();
}
...
==================
*/
void CCamWnd::MarkWorldDirty( void ) {
	worldDirty = true;
	UpdateCaption();
}
...
==================
*/
void CCamWnd::DrawEntityData( void ) {
	qglMatrixMode( GL_MODELVIEW );
	qglLoadIdentity();
	qglMatrixMode( GL_PROJECTION );
	qglLoadIdentity();
...
==================
*/
void CCamWnd::UpdateCameraView( void ) {
...
==================
*/
brush_t* CCamWnd::CreateDropBrush( void ) {
	idVec3	mins, maxs, junk;
	int		i, x, y;
	float	temp;
	brush_t *n;
...
==================
*/
void CCamWnd::PositionView( void ) {
	brush_t *b;
