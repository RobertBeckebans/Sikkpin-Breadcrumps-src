...
/*
 ...
 =======================================================================================================================
 */
void CMainFrame::OnCurvePatchcube()
{
...
/*
 ...
 =======================================================================================================================
 */
void CMainFrame::OnCurveQuickPatch()
{
...
void CMainFrame::OnCaulkSelected()
{
	...
	if( nCount > 0 )
	{
		...
		for( int i = 0; i < nCount; i++ )
		{
			...
			bptd.coords[0][1] = 0.0f;
			bptd.coords[1][0] = 0.0f;
			bptd.coords[0][1] = 0.0f;
			bptd.coords[1][0] = 0.0f;
			bptd.coords[0][2] = 0.0f;
			bptd.coords[1][2] = 0.0f;
			bptd.coords[0][0] = 1.0f;
			bptd.coords[1][1] = 1.0f;
...
void CMainFrame::OnNoDrawSelected()
{
	int nCount = g_ptrSelectedFaces.GetSize();
	if( nCount > 0 )
	{
...
void CMainFrame::OnVisPortalSelected()
{
	int nCount = g_ptrSelectedFaces.GetSize();
	if( nCount > 0 )
	{
