...
//#include "NewProjDlg.h"	// sikk - Removed New Project Dialog
...
//#include "PatchDialog.h"	// sikk - Merged Patch Inspector into Surface Inspector
#include "Undo.h"
#include "NewTexWnd.h"
#include "splines.h"
#include "dlgcamera.h"
...
//#define D3XP_ID_SHOW_MODELS ( WM_USER + 28477 )	// sikk - Removed
...
#define MAX_GRID	256.0f	//  sikk - Larger Grid sizes
#define MIN_GRID	0.125f

SCommandInfo g_Commands[] = {
// File Commands
	{ "File: Open",						'O', 			RAD_CONTROL,					ID_FILE_OPEN },
	{ "File: Save",						'S', 			RAD_CONTROL,					ID_FILE_SAVE },
	{ "File: Save As",					'S', 			RAD_CONTROL|RAD_SHIFT,			ID_FILE_SAVE_AS },	// sikk - Added 
	{ "File: SaveCopy",					'C',			RAD_CONTROL|RAD_ALT|RAD_SHIFT,	ID_FILE_SAVE_COPY_AS },

// Edit Commands
	{ "Edit: Copy",						'C',			RAD_CONTROL,	ID_EDIT_COPYBRUSH },
	{ "Edit: Paste",					'V',			RAD_CONTROL,	ID_EDIT_PASTEBRUSH },
	{ "Edit: Undo",						'Z',			RAD_CONTROL,	ID_EDIT_UNDO },
	{ "Edit: Redo",						'Y',			RAD_CONTROL,	ID_EDIT_REDO },
	
	{ "Edit: Find Brush/Entity",		'F', 			RAD_CONTROL, 			ID_EDIT_FINDBRUSH },	// sikk - Added
	{ "Edit: Find/Replace Textures",    'F', 			RAD_CONTROL|RAD_SHIFT,	ID_EDIT_FINDORREPLACETEXTURE },	// sikk - Modified - was Shift + F
	{ "Edit: Find/Replace Entity k/v",	VK_F3, 			RAD_CONTROL, 			ID_EDIT_FINDORREPLACEENTITY},	
	{ "Edit: Find Next Entity",   		VK_F3,			RAD_SHIFT, 				ID_MISC_FINDNEXTENT},

	{ "Edit: Surface Inspector",		'J', 			0, 				ID_TEXTURES_INSPECTOR },	// sikk - changed from 'S'
	//{ "Edit: Patch Inspector",			'P', 			0, 				ID_PATCH_INSPECTOR },	// sikk - Merged Patch Inspector into Surface Inspector
	{ "Edit: Light Editor",				'L', 			0, 				ID_PROJECTED_LIGHT },	// sikk - changed from 'J'
	{ "Edit: Entity Color Picker",		'K', 			0, 				ID_MISC_SELECTENTITYCOLOR },
	{ "Edit: Entity List",				'I', 			0, 				ID_EDIT_ENTITYINFO },

	{ "Edit: Preferences",				VK_F11, 		0, 				ID_PREFS },

// View Commands
	{ "View: Cycle XY View",			VK_TAB, 		0,				ID_VIEW_NEXTVIEW },	// sikk - Removed RAD_CONTROL
	{ "View: XY Zoom In",				VK_DELETE,		0,				ID_VIEW_ZOOMIN },
	{ "View: XY Zoom Out",				VK_INSERT,		0,				ID_VIEW_ZOOMOUT },
	{ "View: Z Zoom In",				VK_DELETE,		RAD_CONTROL,	ID_VIEW_ZZOOMIN },
	{ "View: Z Zoom Out",				VK_INSERT,		RAD_CONTROL,	ID_VIEW_ZZOOMOUT },
// ---> sikk - WASD Camera Movement
//	{ "Camera_Forward",					VK_UP,			0,				ID_CAMERA_FORWARD },
//	{ "Camera_Back",					VK_DOWN, 		0, 				ID_CAMERA_BACK },
	//{ "View: Camera Forward",			'W', 			RAD_PRESS, 		ID_CAMERA_FORWARD },
	//{ "View: Camera Back",				'S', 			0, 				ID_CAMERA_BACK },
//	{ "View: Camera Left",				VK_LEFT, 		0, 				ID_CAMERA_LEFT },
//	{ "View: Camera Right",				VK_RIGHT, 		0, 				ID_CAMERA_RIGHT },
//	{ "Camera_Up",						'D', 			0, 				ID_CAMERA_STRAFERIGHT },
//	{ "Camera_Down",					'C', 			0, 				ID_CAMERA_DOWN },
//	{ "Camera_AngleUp",					'A', 			0, 				ID_CAMERA_STRAFELEFT },
...
//	{ "Camera_StrafeLeft",				VK_COMMA, 		0, 				ID_CAMERA_STRAFELEFT },
	//{ "View: Camera StrafeRight",		'D', 			0, 				ID_CAMERA_STRAFERIGHT },
	//{ "View: Camera StrafeLeft",		'A', 			0, 				ID_CAMERA_STRAFELEFT },
//	{ "View: Camera UpFloor",			VK_PRIOR, 		0, 				ID_VIEW_UPFLOOR },
//	{ "View: Camera DownFloor",			VK_NEXT, 		0, 				ID_VIEW_DOWNFLOOR },
//	{ "View: Camera CenterView",		VK_END, 		0, 				ID_VIEW_CENTER },
// <--- sikk - WASD Camera Movement
	{ "View: Center",					'C', 			0, 				ID_VIEW_CENTER },

	{ "View: Show/Hide Models",			'M',			RAD_CONTROL,	ID_SHOW_MODELS },

	{ "View: Toggle Lights",			'L', 			RAD_SHIFT, 		ID_VIEW_SHOWLIGHTS },	// sikk - Changed from Alt + 0
	{ "View: Toggle Patches",			'P', 			RAD_CONTROL,	ID_VIEW_SHOWCURVES },
	{ "View: Toggle Clip Brushes",		'1', 			RAD_SHIFT,		ID_VIEW_SHOWCLIP },	// sikk - Modified key - was Ctrl + L
	{ "View: Toggle AAS Brushes",		'2', 			RAD_SHIFT,		ID_VIEW_SHOWHINT },	// sikk - Added Shortcut key

// ---> sikk - Added - Shortcut keys for toggling nodraw/caulk/visportal faces
	{ "View: Toggle Caulk Faces",		'3', 			RAD_SHIFT,		ID_VIEW_SHOWCAULK },
	{ "View: Toggle Nodraw Faces",		'4', 			RAD_SHIFT,		ID_VIEW_SHOW_NODRAW },
	{ "View: Toggle Visportal Faces",	'5', 			RAD_SHIFT,		ID_VIEW_SHOWVISPORTALS },
// <--- sikk - Added - Shortcut keys for toggling nodraw/caulk/visportal faces

	{ "View: Hide Selected",			'H', 			0, 						ID_VIEW_HIDESHOW_HIDESELECTED },
	{ "View: Show Hidden",				'H', 			RAD_SHIFT,				ID_VIEW_HIDESHOW_SHOWHIDDEN },
	{ "View: Hide Not Selected",		'H', 			RAD_CONTROL|RAD_SHIFT,	ID_VIEW_HIDESHOW_HIDENOTSELECTED },

	{ "View: Camera Clip Zoom In",		219, 			0,				ID_VIEW_CUBEIN },	// sikk - Removed the need for Control from these three & switched the zoom in/out keys
	{ "View: Camera Clip Zoom out",		221, 			0,				ID_VIEW_CUBEOUT },
	{ "View: Camera Clip Toggle",		220, 			0,				ID_VIEW_CUBICCLIPPING },

	{ "View: Next Leak Spot",			'K',			RAD_CONTROL|RAD_SHIFT,	ID_MISC_NEXTLEAKSPOT },
	{ "View: Prev Leak Spot",			'L', 			RAD_CONTROL|RAD_SHIFT,	ID_MISC_PREVIOUSLEAKSPOT },

	{ "View: Entity Tab",				'N', 			0, 				ID_VIEW_ENTITY },
	{ "View: Console Tab",				'O', 			0, 				ID_VIEW_CONSOLE },
	{ "View: Textures Tab",				'T', 			0, 				ID_VIEW_TEXTURE },
	{ "View: Media Tab",				'M', 			0, 				ID_VIEW_MEDIABROWSER },

	{ "View: Toggle Camera View",		'C', 			RAD_CONTROL|RAD_SHIFT,	ID_TOGGLECAMERA },
	{ "View: Toggle XY View",			'V', 			RAD_CONTROL|RAD_SHIFT,	ID_TOGGLEVIEW },
	{ "View: Toggle Z View",			'Z', 			RAD_CONTROL|RAD_SHIFT,	ID_TOGGLEZ },
	
	{ "View: Game Window",				VK_F2, 			0, 				ID_SHOW_DOOM },
	{ "View: Toggle Render Mode",		VK_F3, 			0, 				ID_VIEW_RENDERMODE },
	{ "View: Toggle RealtimeBuild",		VK_F4, 			0, 				ID_VIEW_REALTIMEREBUILD },
	{ "View: Toggle EntityOutlines",	VK_F5, 			0, 				ID_VIEW_RENDERENTITYOUTLINES },
	{ "View: Toggle Animation",			VK_F6, 			0, 				ID_VIEW_MATERIALANIMATION},
	{ "View: Rebuild Data",				VK_F7, 			0, 				ID_VIEW_REBUILDRENDERDATA },
	{ "View: Toggle Selections",		VK_F8, 			0, 				ID_VIEW_RENDERSELECTION },
	{ "View: Toggle Sound",				VK_F9,			0, 				ID_VIEW_RENDERSOUND },

// Selection Commands
	{ "Selection: Drag Edges",				'E', 			0, 				ID_SELECTION_DRAGEDGES },
	{ "Selection: Drag Vertices",			'V', 			0, 				ID_SELECTION_DRAGVERTECIES },
	{ "Selection: Clone",					VK_SPACE,		0, 				ID_SELECTION_CLONE },
	{ "Selection: Clone Offset",			VK_SPACE,		RAD_CONTROL, 	ID_SELECTION_CLONE },	// sikk - Added Modifier for Clone with offset
	{ "Selection: Clone Offset2",			VK_SPACE,		RAD_SHIFT, 		ID_SELECTION_CLONE },	// sikk - Added Modifier for Clone with offset
	{ "Selection: Delete",					VK_BACK, 		0, 				ID_SELECTION_DELETE },
	{ "Selection: UnSelect",				VK_ESCAPE,		0, 				ID_SELECTION_DESELECT },
	{ "Selection: Invert",					'I', 			0, 				ID_SELECTION_INVERT },
	{ "Selection: Toggle Move Only",		'Z', 			0, 				ID_SELECTION_MOVEONLY },	// sikk - Changed from  RAD_SHIFT modifier
	{ "Selection: Move Down",				VK_NEXT,		0, 				ID_SELECTION_MOVEDOWN },	// sikk - Changed from VK_SUBTRACT
	{ "Selection: Move Up",					VK_PRIOR, 		0, 				ID_SELECTION_MOVEUP },		// sikk - Changed from VK_ADD
	{ "Selection: Dump Brush",				'D', 			RAD_SHIFT,		ID_SELECTION_PRINT },
	{ "Selection: Nudge Left",				VK_LEFT,		RAD_ALT,		ID_SELECTION_SELECT_NUDGELEFT },
	{ "Selection: Nudge Right",				VK_RIGHT,		RAD_ALT,		ID_SELECTION_SELECT_NUDGERIGHT },
	{ "Selection: Nudge Up",				VK_UP,			RAD_ALT,		ID_SELECTION_SELECT_NUDGEUP },
	{ "Selection: Nudge Down",				VK_DOWN,		RAD_ALT,		ID_SELECTION_SELECT_NUDGEDOWN },
	{ "Selection: Insert Into Entity",		'K', 			RAD_SHIFT,		ID_SELECTION_COMBINE },
	{ "Selection: Connect",					'K', 			RAD_CONTROL,	ID_SELECTION_CONNECT },
	{ "Selection: Ungroup",					'G', 			RAD_SHIFT,		ID_SELECTION_UNGROUPENTITY },
	{ "Selection: CSG Merge",				'M', 			RAD_SHIFT,		ID_SELECTION_CSGMERGE },
	{ "Selection: Center Origin",			'O', 			RAD_SHIFT, 						ID_SELECTION_CENTER_ORIGIN },
	{ "Selection: Select Complete Entity",	'E', 			RAD_CONTROL|RAD_ALT|RAD_SHIFT,	ID_SELECT_COMPLETE_ENTITY },
	{ "Selection: Select All-Of-Type",		'A', 			RAD_CONTROL, 					ID_SELECT_ALL },	// sikk - Changed from RAD_SHIFT
	{ "Selection: Snap To Grid",			'G', 			RAD_CONTROL, 					ID_SELECT_SNAPTOGRID },
	{ "Selection: Snap All To Grid",		'G', 			RAD_CONTROL|RAD_SHIFT, 			ID_SELECT_SNAPALLTOGRID },	// sikk - Added - snap all brushes to grid command
	{ "Selection: Auto Caulk",				'A', 			RAD_CONTROL|RAD_SHIFT,			ID_AUTOCAULK },	// ctrl-shift-a, since SHIFT-A is already taken
// ---> sikk - Added - Caulk/NoDraw/VisPortal Selected
	{ "Selection: Caulk Selected",			'3', 			RAD_CONTROL|RAD_SHIFT,			ID_SELECT_CAULKSELECTED },
	{ "Selection: NoDraw Selected",			'4', 			RAD_CONTROL|RAD_SHIFT,			ID_SELECT_NODRAWSELECTED },
	{ "Selection: VisPortal Selected",		'5', 			RAD_CONTROL|RAD_SHIFT,			ID_SELECT_VISPORTALSELECTED },
// <--- sikk - Added - Caulk/NoDraw/VisPortal Selected

	{ "Selection: Toggle Clipper",		'X', 			0, 				ID_VIEW_CLIPPER },
	{ "Selection: Clip Selected",		VK_RETURN, 		0, 				ID_CLIP_SELECTED },
	{ "Selection: Split Selected",		VK_RETURN, 		RAD_SHIFT, 		ID_SPLIT_SELECTED },
	{ "Selection: Flip Clip",			VK_RETURN, 		RAD_CONTROL,	ID_FLIP_CLIP },
	{ "Selection: Mouse Rotate",		'R', 			0, 				ID_SELECT_MOUSEROTATE },
	{ "Selection: ToggleFlatRotation",	'R', 			RAD_CONTROL,	ID_VIEW_CAMERAUPDATE },
	{ "Selection: CycleRotationAxis",	'R', 			RAD_SHIFT,		ID_TOGGLE_ROTATELOCK },

// Texture Commands
	{ "Texture: Axial By Height",		'U',			0,						ID_SELECT_AXIALTEXTURE_BYHEIGHT },
	{ "Texture: Axial Arbitrary",		'U',			RAD_SHIFT,				ID_SELECT_AXIALTEXTURE_ARBITRARY },
	{ "Texture: Axial By Width",		'U',			RAD_CONTROL,			ID_SELECT_AXIALTEXTURE_BYWIDTH },
	{ "Texture: Decrement",				VK_HOME,		RAD_SHIFT, 				ID_SELECTION_TEXTURE_DEC },	// sikk - Changed - was VK_SUBTRACT
	{ "Texture: Increment",				VK_END,			RAD_SHIFT, 				ID_SELECTION_TEXTURE_INC },	// sikk - Changed - was VK_ADD
	{ "Texture: Fit",					'F',			RAD_SHIFT, 				ID_SELECTION_TEXTURE_FIT },	// sikk - Modified - was Shift + 5
	{ "Texture: Rotate Clock",			VK_NEXT,		RAD_SHIFT, 				ID_SELECTION_TEXTURE_ROTATECLOCK },
	{ "Texture: Rotate Counter",		VK_PRIOR,		RAD_SHIFT, 				ID_SELECTION_TEXTURE_ROTATECOUNTER },
	{ "Texture: Scale Up",				VK_UP,			RAD_CONTROL,			ID_SELECTION_TEXTURE_SCALEUP },
	{ "Texture: Scale Down",			VK_DOWN,		RAD_CONTROL,			ID_SELECTION_TEXTURE_SCALEDOWN },
	{ "Texture: Shift Left",			VK_LEFT,		RAD_SHIFT, 				ID_SELECTION_TEXTURE_SHIFTLEFT },
	{ "Texture: Shift Right",			VK_RIGHT,		RAD_SHIFT, 				ID_SELECTION_TEXTURE_SHIFTRIGHT },
	{ "Texture: Shift Up",				VK_UP,			RAD_SHIFT,				ID_SELECTION_TEXTURE_SHIFTUP },
	{ "Texture: Shift Down",			VK_DOWN,		RAD_SHIFT,				ID_SELECTION_TEXTURE_SHIFTDOWN },
	{ "Texture: Scale Left",			VK_LEFT,		RAD_CONTROL,			ID_SELECTION_TEXTURE_SCALELEFT },
	{ "Texture: Scale Right",			VK_RIGHT,		RAD_CONTROL,			ID_SELECTION_TEXTURE_SCALERIGHT },
	{ "Texture: Invert X",				'I',			RAD_CONTROL|RAD_SHIFT,	ID_CURVE_NEGATIVETEXTUREY },
	{ "Texture: Invert Y",				'I',			RAD_SHIFT,				ID_CURVE_NEGATIVETEXTUREX },
	{ "Texture: Toggle Lock",			'T',			RAD_SHIFT,				ID_TOGGLE_LOCK },
	{ "Texture: Show All Textures",		'A',			RAD_SHIFT,				ID_TEXTURES_SHOWINUSE },	// sikk - Changed - was RAD_CONTROL & ID_TEXTURES_SHOWALL (there's no need for 'show all') 
	{ "Texture: Naturalize Patch",		'N', 			RAD_CONTROL, 			ID_PATCH_NATURALIZE },
	{ "Texture: Naturalize Patch Alt",	'N', 			RAD_SHIFT, 				ID_PATCH_NATURALIZEALT },

// Grid Commands
	// sikk - Remove these temporarily
	//{ "Grid: Set 0.5",					'4',			RAD_SHIFT,		ID_GRID_POINT5 },
	//{ "Grid: Set 0.25",					'3',			RAD_SHIFT,		ID_GRID_POINT25 },
	//{ "Grid: Set 0.125",				'2',			RAD_SHIFT,		ID_GRID_POINT125 },
	//{ "Grid: SetPoint0625",			'1',			RAD_SHIFT,		ID_GRID_POINT0625 },
	{ "Grid: Set 1",					'1',			0,				ID_GRID_1 },
	{ "Grid: Set 2",					'2',			0,				ID_GRID_2 },
	{ "Grid: Set 4",					'3',			0,				ID_GRID_4 },
	{ "Grid: Set 8",					'4',			0,				ID_GRID_8 },
	{ "Grid: Set 16",					'5',			0,				ID_GRID_16 },
	{ "Grid: Set 32",					'6',			0,				ID_GRID_32 },
	{ "Grid: Set 64",					'7',			0,				ID_GRID_64 },
// ---> sikk - Larger Grid sizes
	{ "Grid: Set 128",					'8', 			0, 				ID_GRID_128 },
	{ "Grid: Set 256",					'9', 			0, 				ID_GRID_256 },
// <--- sikk - Larger Grid sizes
	{ "Grid: Down",						VK_MINUS, 		0, 				ID_GRID_PREV },	// sikk - Changed from '219'
	{ "Grid: Up",						VK_PLUS, 		0, 				ID_GRID_NEXT },	// sikk - Changed from '221'
	{ "Grid: Toggle",					'0', 			0, 				ID_GRID_TOGGLE },
	{ "Grid: Toggle Size Paint",		'P', 			RAD_PRESS,		ID_SELECTION_TOGGLESIZEPAINT },	// sikk - Changed from 'Q'

	{ "Grid: Precision Cursor Mode",	VK_F11, 		0, 				ID_PRECISION_CURSOR_CYCLE},

	{ "Grid: Toggle Crosshairs",		'X', 			RAD_SHIFT,		ID_VIEW_CROSSHAIR },


// Brush Commands
	{ "Brush: Make 3 Sided",			'3', 			RAD_CONTROL,	ID_BRUSH_3SIDED },
	{ "Brush: Make 4 Sided",			'4', 			RAD_CONTROL,	ID_BRUSH_4SIDED },
	{ "Brush: Make 5 Sided",			'5', 			RAD_CONTROL,	ID_BRUSH_5SIDED },
	{ "Brush: Make 6 Sided",			'6', 			RAD_CONTROL,	ID_BRUSH_6SIDED },
	{ "Brush: Make 7 Sided",			'7', 			RAD_CONTROL,	ID_BRUSH_7SIDED },
	{ "Brush: Make 8 Sided",			'8', 			RAD_CONTROL,	ID_BRUSH_8SIDED },
	{ "Brush: Make 9 Sided",			'9', 			RAD_CONTROL,	ID_BRUSH_9SIDED },

// Patch Commands
	{ "Patch: Make Quick Sheet",		'Q', 			0, 						ID_CURVE_PATCHQUICK },
	{ "Patch: Make Quick Cube",			'Q', 			RAD_CONTROL, 			ID_CURVE_PATCHCUBE },
	{ "Patch: Make Quick Cylinder",		'Q', 			RAD_SHIFT, 				ID_CURVE_PATCHTUBE },
	{ "Patch: Make Quick Cone",			'Q', 			RAD_CONTROL|RAD_SHIFT, 	ID_CURVE_PATCHCONE },
	{ "Patch: Bend Mode",				'B', 			0, 						ID_PATCH_BEND },
	{ "Patch: Freeze Vertices",			'F', 			0, 						ID_CURVE_FREEZE },
	{ "Patch: UnFreeze Vertices",		'F', 			RAD_CONTROL|RAD_ALT,			ID_CURVE_UNFREEZE },	// sikk - Modified - was Ctrl + F
	{ "Patch: UnFreeze All Vertices",	'F', 			RAD_CONTROL|RAD_ALT|RAD_SHIFT,	ID_CURVE_UNFREEZEALL },	// sikk - Modified - was Ctrl + Shift + F
	{ "Patch: Thicken",					'T', 			RAD_CONTROL,			ID_CURVE_THICKEN },
	{ "Patch: Clear Overlays",			'Y', 			RAD_SHIFT,				ID_CURVE_OVERLAY_CLEAR },
	{ "Patch: Make Overlay",			'Y', 			0, 						ID_CURVE_OVERLAY_SET },
	{ "Patch: Cycle Cap Texturing",		'P', 			RAD_CONTROL|RAD_SHIFT,	ID_CURVE_CYCLECAP },
	{ "Patch: Cycle Cap TexturingAlt",	'P', 			RAD_SHIFT, 				ID_CURVE_CYCLECAPALT },
	{ "Patch: Invert Curve",			'I', 			RAD_CONTROL, 			ID_CURVE_NEGATIVE },
// ---> sikk - Modified/Added to these
	{ "Patch: Add First Column",		VK_ADD,			0,						ID_CURVE_INSERT_INSERTCOLUMN },
	{ "Patch: Add Last Column",			VK_ADD, 		RAD_SHIFT,				ID_CURVE_INSERT_ADDCOLUMN },
	{ "Patch: Delete First Column",		VK_SUBTRACT, 	0,						ID_CURVE_DELETE_FIRSTCOLUMN },
	{ "Patch: Delete Last Column",		VK_SUBTRACT,	RAD_SHIFT,				ID_CURVE_DELETE_LASTCOLUMN },
	{ "Patch: Add First Row",			VK_ADD,			RAD_CONTROL,			ID_CURVE_INSERT_INSERTROW },
	{ "Patch: Add Last Row",			VK_ADD, 		RAD_CONTROL|RAD_SHIFT, 	ID_CURVE_INSERT_ADDROW },
	{ "Patch: Delete First Row",		VK_SUBTRACT, 	RAD_CONTROL, 			ID_CURVE_DELETE_FIRSTROW },
	{ "Patch: Delete Last Row",			VK_SUBTRACT,	RAD_CONTROL|RAD_SHIFT, 	ID_CURVE_DELETE_LASTROW },
// <--- sikk - Modified/Added to these
	{ "Patch: Redisperse Rows",			'E', 			RAD_CONTROL, 			ID_CURVE_REDISPERSE_ROWS },
	{ "Patch: Redisperse Cols",			'E', 			RAD_CONTROL|RAD_SHIFT,	ID_CURVE_REDISPERSE_COLS },
	{ "Patch: Cap Current Curve",		'C', 			RAD_SHIFT, 				ID_CURVE_CAP },
	{ "Patch: TAB",						VK_TAB, 		RAD_CONTROL,			ID_PATCH_TAB },	// sikk - Added RAD_CONTROL
...
// <--- sikk - Added
	...
	{ "Comma", VK_COMMA },
	{ "Period", VK_PERIOD },
	{ "Add", VK_ADD },	//sikk - Changed from "Plus"
	{ "Multiply", VK_MULTIPLY },
	{ "Subtract", VK_SUBTRACT },
	{ "Decimal", VK_DECIMAL },	// sikk - Added
	{ "Divide", VK_DIVIDE },	// sikk - Added
	{ "NumPad0", VK_NUMPAD0 },
	{ "NumPad1", VK_NUMPAD1 },
	{ "NumPad2", VK_NUMPAD2 },
	{ "NumPad3", VK_NUMPAD3 },
...
//{{AFX_MSG_MAP(CMainFrame)
	...
	ON_COMMAND(ID_FILE_SAVE_COPY_AS, OnFileSaveCopy)
	...
	ON_COMMAND(ID_EDIT_FINDBRUSH, OnMiscFindbrush)
	...
	ON_COMMAND(ID_EDIT_FINDORREPLACEENTITY, OnMiscFindOrReplaceEntity)
	...
	ON_COMMAND(ID_COLORS_CAMBK, OnColorsCameraBk)	// sikk - Added - Cam Background Color Selection
	ON_COMMAND(ID_COLORS_TEXTUREBK, OnTexturebk)
	...
	ON_COMMAND(ID_EDIT_FINDORREPLACETEXTURE, OnTextureReplaceall)
	...
	ON_COMMAND(ID_CURVE_PATCHCUBE, OnCurvePatchcube)	// sikk - Added - Cube Patch
	ON_COMMAND(ID_CURVE_PATCHQUICK, OnCurveQuickPatch)	// sikk - Added - Quick Patch
	...
	ON_COMMAND(ID_PATCH_INVERTNORMAL, OnPatchInvertNormals)	// sikk - Added - Patch Invert Normals
	ON_COMMAND(ID_SELECT_SNAPTOGRID, OnSnapToGrid)
	ON_COMMAND(ID_SELECT_SNAPALLTOGRID, OnSnapAllToGrid)	// sikk - Added - snap all brushes to grid command
// ---> sikk - Added - Caulk/NoDraw/VisPortal Selected
	ON_COMMAND(ID_SELECT_CAULKSELECTED, OnCaulkSelected)
	ON_COMMAND(ID_SELECT_NODRAWSELECTED, OnNoDrawSelected)
	ON_COMMAND(ID_SELECT_VISPORTALSELECTED, OnVisPortalSelected)
// <--- sikk - Added - Caulk/NoDraw/VisPortal Selected
	...
	//ON_COMMAND(ID_PATCH_INSPECTOR, OnPatchInspector)// sikk - Merged Patch Inspector into Surface Inspector
	...
	ON_COMMAND(ID_VIEW_SHOWVISPORTALS, OnViewShowShowvisportals)
	...
	ON_COMMAND_RANGE(ID_GRID_128, ID_GRID_256, OnGrid1)	// sikk - Larger Grid Sizes
#if _MSC_VER < 1300
...
void CMainFrame::SetButtonMenuStates() {
	...
	if (pMenu) {
		...
		pMenu->CheckMenuItem(ID_VIEW_SHOWVISPORTALS, MF_BYCOMMAND | MF_CHECKED);
		...
		if (g_qeglobals.d_savedinfo.exclude & EXCLUDE_VISPORTALS) {
			pMenu->CheckMenuItem(ID_VIEW_SHOWVISPORTALS, MF_BYCOMMAND | MF_UNCHECKED);
		}
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) {
	...
	// sikk - removed old toolbar
	UINT	nID = IDR_TOOLBAR_ADVANCED;
...
/*
 ...
 =======================================================================================================================
 */
void CMainFrame::RoutineProcessing( void ) {
	if ( m_bDoLoop ) {
		double	time = 0.0;
...
//	m_wndInspectors = g_Inspectors;	// sikk - Window Snapping
...
// ---> sikk - Center command changed to "Center on Selection"
	...
	if ( m_pXZWnd ) {
		m_pXZWnd->PositionView();
	}
	if ( m_pYZWnd ) {
		m_pYZWnd->PositionView();
	}
	if ( m_pCamWnd ) {
		m_pCamWnd->PositionView();
	}
	if ( m_pZWnd ) {
		m_pZWnd->PositionView();
	}
...
void CMainFrame::OnViewZzoomin() {
	z.scale *= 5.0f / 4.0f;
	if ( z.scale > 16.0f ) {	// sikk - Changed from 4.0f
		z.scale = 16.0f;
	}
...
void CMainFrame::OnViewZzoomout() {
	z.scale *= 4.0f / 5.0f;
	if ( z.scale < 0.015625f ) {	// sikk - Changed from 0.125f
		z.scale = 0.015625f;
	}
...
static void UpdateGrid(void)
{
	...
	g_qeglobals.d_selectedgridsize = g_qeglobals.d_gridsize;	// sikk - Added
}
...
// sikk - Need to move this to it's own function
//	m_pCamWnd->Camera().origin += -SPEED_MOVE * m_pCamWnd->Camera().vpn;
...
/*
 ...
 =======================================================================================================================
 */
void CMainFrame::OnFlipClip( void ) {
	if ( m_pActiveXY ) {
...
// ---> sikk - Use better values for rotation, also show this on the statis instead of "g_PrefsDlg.m_nRotation"
	int rot = g_qeglobals.d_gridsize;
	if ( g_qeglobals.d_gridsize == 4 ) { rot = 5; }
	else if ( g_qeglobals.d_gridsize == 8 ) { rot = 15; }
	else if ( g_qeglobals.d_gridsize == 16 ) { rot = 45; }
	else if ( g_qeglobals.d_gridsize >= 32 ) { rot = 90; }
	//else if ( g_qeglobals.d_gridsize >= 64 ) { rot = 90; }
	//else if ( g_qeglobals.d_gridsize == 128 ) { rot = 90; }
	//else if ( g_qeglobals.d_gridsize == 256 ) { rot = 180; }
// <--- sikk - Use better values for rotation, also show this on the statis instead of "g_PrefsDlg.m_nRotation"

	strStatus.Format( "G:%1.2f T:%1.2f R:%i C:%i L:%c%c",
...
/*
 ...
 =======================================================================================================================
 */
void CMainFrame::OnCurvePatchcube( void ) {
	Undo_Start( "make curve cube" );
	Undo_AddBrushList( &selected_brushes );
	Patch_BrushToCubeMesh();
	Sys_UpdateWindows( W_ALL );
	Undo_EndBrushList( &selected_brushes );
	Undo_End();
}
...
// ---> sikk - Added - Quick Patch
/*
 =======================================================================================================================
 =======================================================================================================================
 */
void CMainFrame::OnCurveQuickPatch( void ) {
	Undo_Start( "make curve quick mesh" );
	Undo_AddBrushList( &selected_brushes );
	if ( g_pParentWnd->GetFocus() == g_pParentWnd->GetCamera() ) {
		//idVec3 dir = g_pParentWnd->GetCamera()->Camera().origin - ( ( selected_brushes.next->maxs - selected_brushes.next->mins ) * 0.5 + selected_brushes.next->mins );
		//dir.Normalize();
		idVec3 dir = -g_pParentWnd->GetCamera()->Camera().vpn;
		idVec3 dirAbs;
		dirAbs.x = fabs( dir.x ); dirAbs.y = fabs( dir.y ); dirAbs.z = fabs( dir.z );
		float f = max( max( dirAbs.x, dirAbs.y ), dirAbs.z );

		if ( f == dirAbs.x ) {
			if ( dir.x > 0 ) {
				Patch_GenerateQuick( 3, 3, 0 );
			} else {
				Patch_GenerateQuick( 3, 3, 3 );
			}
		} else if ( f == dirAbs.y ) {
			if ( dir.y < 0 ) {
				Patch_GenerateQuick( 3, 3, 1 );
			} else {
				Patch_GenerateQuick( 3, 3, 4 );
			}
		} else {
			if ( dir.z > 0 ) {
				Patch_GenerateQuick( 3, 3, 2 );
			} else {
				Patch_GenerateQuick( 3, 3, 5 );
			}
		}
	} else {
		Patch_GenerateQuick( 3, 3, g_pParentWnd->ActiveXY()->GetViewType() );
	}
	Sys_UpdateWindows( W_ALL );
	Undo_EndBrushList( &selected_brushes );
	Undo_End();
...
// ---> sikk - Added - Patch Invert Normals
/*
 =======================================================================================================================
 =======================================================================================================================
 */
void CMainFrame::OnPatchInvertNormals() {
	Patch_InvertNormals();
	Sys_UpdateWindows( W_ALL );
}
// <--- sikk - Added - Patch Invert Normals
...
// ---> sikk - Added - snap all brushes to grid command
/*
 =======================================================================================================================
 =======================================================================================================================
 */
void CMainFrame::OnSnapAllToGrid() {
	Select_SnapAllToGrid();
	Sys_UpdateWindows( W_ALL );
}
// <--- sikk - Added - snap all brushes to grid command
...
void CMainFrame::OnViewShowShowvisportals() 
{
	if ((g_qeglobals.d_savedinfo.exclude ^= EXCLUDE_VISPORTALS) & EXCLUDE_VISPORTALS) {
		CheckMenuItem(::GetMenu(GetSafeHwnd()), ID_VIEW_SHOWVISPORTALS, MF_BYCOMMAND | MF_UNCHECKED);
	}
	else {
		CheckMenuItem(::GetMenu(GetSafeHwnd()), ID_VIEW_SHOWVISPORTALS, MF_BYCOMMAND | MF_CHECKED);
	}
...
=======================================================================================================================
*/
// ---> sikk - Added - Caulk/NoDraw Selected
void CMainFrame::OnCaulkSelected( void ) {
	...
	if ( nCount > 0 ) {
		...
		for ( int i = 0; i < nCount; i++ ) {
			...
			td.SetName( "textures/common/caulk" );
			td.shift[0] = 0.0; td.shift[1] = 0.0;
			td.rotate = 0;	
			td.scale[0] = 1; td.scale[1] = 1;
			td.value = 0;
			brushprimit_texdef_t bptd;
			memset ( &bptd, 0, sizeof( bptd ) );
			bptd.coords[0][1] = 0.0f; bptd.coords[1][0] = 0.0f;
			bptd.coords[0][1] = 0.0f; bptd.coords[1][0] = 0.0f;
			bptd.coords[0][2] = 0.0f; bptd.coords[1][2] = 0.0f;
			bptd.coords[0][0] = 1.0f; bptd.coords[1][1] = 1.0f;
			SetFaceTexdef( selBrush, selFace, &td, &bptd, false );
			Brush_Build( selBrush, false );
		}
	}

	for ( brush_t *pb = selected_brushes.next; pb != &selected_brushes; pb = pb->next ) {
		if ( !pb->pPatch && !pb->owner->eclass->fixedsize ) {
			for ( face_t *f = pb->brush_faces; f; f = f->next) {
				...
				bptd.coords[0][2] = 0.0f; bptd.coords[1][2] = 0.0f;
				bptd.coords[0][0] = 1.0f; bptd.coords[1][1] = 1.0f;
				SetFaceTexdef( pb, f, &td, &bptd, false );
			}
			Brush_Build( pb, false );
		}
	}
	Sys_UpdateWindows( W_ALL );
}

void CMainFrame::OnNoDrawSelected( void ) {
	int nCount = g_ptrSelectedFaces.GetSize();
	if ( nCount > 0 ) {
		ASSERT( g_ptrSelectedFaces.GetSize() == g_ptrSelectedFaceBrushes.GetSize() );
		for ( int i = 0; i < nCount; i++ ) {
			...
			texdef_t td;
			memset ( &td, 0, sizeof( td ) );
			td.SetName( "textures/common/nodraw" );
			td.shift[0] = 0.0; td.shift[1] = 0.0;
			td.rotate = 0;	
			td.scale[0] = 1; td.scale[1] = 1;
			td.value = 0;
...
void CMainFrame::OnVisPortalSelected( void ) {
	int nCount = g_ptrSelectedFaces.GetSize();
	if ( nCount > 0 ) {
		ASSERT( g_ptrSelectedFaces.GetSize() == g_ptrSelectedFaceBrushes.GetSize() );
		for ( int i = 0; i < nCount; i++ ) {
			...
			texdef_t td;
			memset ( &td, 0, sizeof( td ) );
			td.SetName( "textures/common/visportal" );
			td.shift[0] = 0.0; td.shift[1] = 0.0;
			td.rotate = 0;	
			td.scale[0] = 1; td.scale[1] = 1;
			td.value = 0;
