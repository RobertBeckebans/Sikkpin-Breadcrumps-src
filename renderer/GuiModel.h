...
typedef struct {
	...
	float				shaderParms[32];	// sikk - pass shader parms to GUI model for post FX
} guiModelSurface_t;
...
public:
	...
	void	SetShaderParm( int parm, float value );	// sikk - pass shader parms to GUI model for post FX
