...
void	idRenderWorldLocal::WriteRenderLight( qhandle_t handle, const renderLight_t *light ) {
	...
	session->writeDemo->WriteBool( light->ambient );	// sikk - Ambient Light Flag
// ---> sikk - Ambient Light Color
	session->writeDemo->WriteVec3( light->ambColor_X_Neg );
	session->writeDemo->WriteVec3( light->ambColor_X_Pos );
	session->writeDemo->WriteVec3( light->ambColor_Y_Neg );
	session->writeDemo->WriteVec3( light->ambColor_Y_Pos );
	session->writeDemo->WriteVec3( light->ambColor_Z_Neg );
	session->writeDemo->WriteVec3( light->ambColor_Z_Pos );
// <--- sikk - Ambient Light Color
	session->writeDemo->WriteVec3( light->ambRotation );	// sikk - Ambient Light Rotation
...
void	idRenderWorldLocal::ReadRenderLight( ) {
	...
	session->readDemo->ReadBool( light.ambient );	// sikk - Ambient Light Flag
// ---> sikk - Ambient Light Color
	session->readDemo->ReadVec3( light.ambColor_X_Neg );
	session->readDemo->ReadVec3( light.ambColor_X_Pos );
	session->readDemo->ReadVec3( light.ambColor_Y_Neg );
	session->readDemo->ReadVec3( light.ambColor_Y_Pos );
	session->readDemo->ReadVec3( light.ambColor_Z_Neg );
	session->readDemo->ReadVec3( light.ambColor_Z_Pos );
// <--- sikk - Ambient Light Color
	session->readDemo->ReadVec3( light.ambRotation );	// sikk - Ambient Light Rotation
...
void	idRenderWorldLocal::WriteRenderEntity( qhandle_t handle, const renderEntity_t *ent ) {
	...
	session->writeDemo->WriteBool( ent->ambLightUseCenter );	// sikk - this is a fix for ragdolls when their orgin clips into the world causing
																// ambient lighting to cut out. When this is set, we use their bounds' center 
...
void	idRenderWorldLocal::ReadRenderEntity() {
	...
	session->readDemo->ReadBool( ent.ambLightUseCenter );	// sikk - this is a fix for ragdolls when their orgin clips into the world causing
															// ambient lighting to cut out. When this is set, we use their bounds' center 
