...
void R_LinkLightSurf( const drawSurf_t **link, const srfTriangles_t *tri, const viewEntity_t *space, 
	...
	if ( !shader ) {
		...
		if ( !tr.backEndRendererHasVertexPrograms && !r_skipSpecular.GetBool() /* sikk - && tr.backEndRenderer != BE_ARB*/ ) {
...
=================
*/
void R_AddSSAODrawSurf( const srfTriangles_t *tri, const viewEntity_t *space, const renderEntity_t *renderEntity,
					const idMaterial *shader, const idScreenRect &scissor ) {
	drawSurf_t		*drawSurf;
	const float		*shaderParms;
	static float	refRegs[MAX_EXPRESSION_REGISTERS];	// don't put on stack, or VC++ will do a page touch
	...
	//common->Printf( "R_AddSSAODrawSurf()\n" );
