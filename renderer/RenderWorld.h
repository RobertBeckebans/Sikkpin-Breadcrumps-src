...
// shader parms
const int MAX_GLOBAL_SHADER_PARMS	= 32;	// sikk - was 12;
...
typedef struct renderEntity_s
{
	...
	bool					ambLightUseCenter;		// sikk - this is a fix for ragdolls when their orgin clips into the world causing
...
typedef struct renderLight_s
{
	...
	bool					ambient;	// sikk - Ambient Light Flag
...
public:
	...
	virtual	void			RenderSceneSSAO( const renderView_t* renderView ) = 0;	// sikk - ssao test
