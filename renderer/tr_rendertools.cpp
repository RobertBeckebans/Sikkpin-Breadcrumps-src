...
void RB_ShowStencilBuffer()
{
	...
	qglDrawPixels( glConfig.vidWidth, glConfig.vidHeight, GL_RGBA , GL_UNSIGNED_BYTE, stencilReadback );
	R_StaticFree( stencilReadback );
}
// <--- sikk - Show Stencil Buffer
...
void RB_RenderDebugTools( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	...
	RB_ShowSilhouette();
	RB_ShowDepthBuffer();
	RB_ShowStencilBuffer();	// sikk - Show Stencil Buffer
	RB_ShowIntensity();
	RB_ShowDebugLines();
	RB_ShowDebugText();
	RB_ShowDebugPolygons();
