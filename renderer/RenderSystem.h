...
typedef struct glconfig_s
{
	...
	bool				GLSLAvailable;	// sikk - raynorpat's GLSL Support
	bool				ARBMapBufferRangeAvailable;	// sikk - Mh & reckless VBO
	...
	bool				allowR200Path;
	bool				allowARB2Path;
	bool				allowGLSLPath;	// sikk - raynorpat's GLSL Support
...
public:
	...
	virtual void			SetShaderParm( int parm, float value ) = 0;	// sikk - pass shader parms to GUI model for post FX
	...
	virtual void			CaptureRenderToImage( const char* imageName, bool nearest = false ) = 0;	// sikk - nearest texture filter for framebuffer - added 'bool nearest' arg
	virtual void			CaptureDepthToImage( const char* imageName ) = 0;	// sikk - Capture Depth Buffer to Image
