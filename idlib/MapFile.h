...
// ---> sikk - old Brush Format
	void					SetPlanePoints( const idVec3 pts[3] ) { planePts[0] = pts[0]; planePts[1] = pts[1]; planePts[2] = pts[2]; }
	void					GetPlanePoints( idVec3 &pts1, idVec3 &pts2, idVec3 &pts3 ) { pts1 = planePts[0]; pts2 = planePts[1]; pts3 = planePts[2]; }
// <--- sikk - old Brush Format
...
protected:
	...
	idVec3					texMat[2];
	idVec3					origin;
	idVec3					planePts[3];	// sikk - old Brush Format
};
...
public:
	...
	bool					Write( idFile *fp, int primitiveNum, const idVec3 &origin, bool newFormat = true ) const;	// sikk - Old Brush Format - added "bool newFormat" arg
...
public:
	...
	bool					Write( idFile *fp, int entityNum, bool newFormat = true ) const;	// sikk - Old Brush Format - added "bool newFormat" arg
...
public:
	...
	bool					Write( const char *fileName, const char *ext, bool fromBasePath = true, bool newFormat = true );	// sikk - Old Brush Format - added "bool newFormat" arg
