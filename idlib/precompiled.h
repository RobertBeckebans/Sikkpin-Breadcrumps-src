...
#if defined(_D3XP)
#include "../d3xp/Game.h"
// ---> sikk - Breadcrumb define
#elif defined(_SIKKBC)
#include "../game-bc/Game.h"
// <--- sikk - Breadcrumb define
// ---> sikk - Illuminated define
#elif defined(_SIKKILL)
#include "../game-ill/Game.h"
// <--- sikk - Illuminated define
// ---> sikk - Help define
#elif defined(_SIKKHELP)
#include "../game-help/Game.h"
// <--- sikk - Help define
#else
#include "../game/Game.h"
#endif
...
// ---> sikk - Breadcrumb define
#elif defined(_SIKKBC)
#include "../game-bc/Game_local.h"
// <--- sikk - Breadcrumb define
// ---> sikk - Illuminated define
#elif defined(_SIKKILL)
#include "../game-ill/Game_local.h"
// <--- sikk - Illuminated define
// ---> sikk - Help define
#elif defined(_SIKKHELP)
#include "../game-help/Game_local.h"
// <--- sikk - Help define
#else
