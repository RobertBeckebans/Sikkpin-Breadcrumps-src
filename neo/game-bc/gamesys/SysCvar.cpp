...
idCVar g_useDynamicProtection(	"g_useDynamicProtection",	"0",			CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "scale damage and armor dynamically to keep the player alive more often" );
...
idCVar g_maxShowDistance(	"g_maxShowDistance",		"512",			CVAR_GAME | CVAR_FLOAT, "" );	// sikk - was 128
...
idCVar g_viewNodalZ(	"g_viewNodalZ",				"8",			CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT, "" );	// sikk - default to 8 (was 0)
...
idCVar pm_crouchspeed(	"pm_crouchspeed",			"160",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while crouched" );
idCVar pm_walkspeed(	"pm_walkspeed",				"320",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while walking" );
...
idCVar pm_staminathreshold(	"pm_staminathreshold",		"4",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "when stamina drops below this value, player gradually slows to a walk" );
...
// server info
idCVar si_name(	"si_name",					"Feedback Server",	CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE, "name of the server" );
...
// ---> sikk - Level Music
idCVar s_volumeMusic(	"s_volumeMusic",				"0.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"sets volume (in dB) of the background music" );
// <--- sikk - Level Music
...
// ---> sikk - Ambient sounds
idCVar g_musicTimeAmbientMin(	"g_musicTimeAmbientMin",		"45",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"ambient sound change min time (in sec)." );
idCVar g_musicTimeAmbientMax(	"g_musicTimeAmbientMax",		"45",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"ambient sound change max time (in sec)." );
idCVar g_musicTime1ShotMin(	"g_musicTime1ShotMin",			"45",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"1-shot ambient sound play min time (in sec)." );
idCVar g_musicTime1ShotMax(	"g_musicTime1ShotMax",			"90",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"1-shot ambient sound play max time (in sec)." );
// <--- sikk - Ambient sounds

// ---> sikk - Portal Sky Box
idCVar g_testHeartRate(	"g_testHeartRate",				"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_INTEGER,	"sets the current heartrate if > 0" );
// <--- sikk - Portal Sky Box

// ---> sikk - Ladder Speed CVAR
idCVar pm_ladderspeed(	"pm_ladderspeed",				"220",		CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while on a ladder" );
// <--- sikk - Ladder Speed CVAR
...
//idCVar r_hdrWhitePoint(				"r_hdrWhitePoint",				"1.2",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Smallest luminance value that will be mapped to white" );
...
//idCVar r_hdrBloomThreshold(			"r_hdrBloomThreshold",			"6.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Bloom luminance threshold" );
...
//idCVar r_hdrBloomSize(				"r_hdrBloomSize",				"0.5",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Size of the bloom effect" );
//idCVar r_hdrFlareGamma(				"r_hdrFlareGamma",				"4.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Gamma curve for the flare texture" );
//idCVar r_hdrFlareScale(				"r_hdrFlareScale",				"2.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Intensity scale amount for lens flare effect. 0 = Off" );
//idCVar r_hdrFlareSize(				"r_hdrFlareSize",				"2.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Size of the lens flare effect" );
//idCVar r_hdrGlareScale(				"r_hdrGlareScale",				"2.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Intensity scale amount for glare effect" );
...
idCVar r_bloomBlurIterations(	"r_bloomBlurIterations",		"2",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"Number of times the blur filter is applied" );
idCVar r_bloomBlurScaleX(	"r_bloomBlurScaleX",			"1.5",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Amount to scale the X axis sample offsets" );
idCVar r_bloomBlurScaleY(	"r_bloomBlurScaleY",			"1.5",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Amount to scale the Y axis sample offsets" );
...
idCVar r_ssaoBufferSize(	"r_ssaoBufferSize",				"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"SSAO buffer size:\n0 = full\n1 = full (nearest power-of-two)\n2 = half\n3 = half (nearest power-of-two)" );
idCVar r_ssaoRadius(	"r_ssaoRadius",					"16",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Set the sample radius for ssao" );
idCVar r_ssaoBias(	"r_ssaoBias",					"0.075",	CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Set the angle bias for ssao" );
idCVar r_ssaoAmount(	"r_ssaoAmount",					"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Set the contribution factor for ssao" );
idCVar r_ssaoSelfOcclusion(	"r_ssaoSelfOcclusion",			"0.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Set the self-occlusion factor for ssao" );
...
//idCVar r_sunShaftsStrength(			"r_sunShaftsStrength",			"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Set the sun shafts strength" );
//idCVar r_sunShaftsHazeStrength(		"r_sunShaftsHazeStrength",		"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"Set the sun shafts haze strength" );
//idCVar r_sunShaftsQuality(			"r_sunShaftsQuality",			"3",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"Set the sun shafts quality" );
//
//idCVar r_useLensFlares(				"r_useLensFlares",				"0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"Enable lens flare postprocessing effect" );
//
