...
// ---> sikk - Mouse Fix for guis: 1x1 movement
		cursorX += event->evValue * (float)( 640.0f / renderSystem->GetScreenWidth() );
		cursorY += event->evValue2 * (float)( 480.0f / renderSystem->GetScreenHeight() );
// <--- sikk - Mouse Fix for guis: 1x1 movement
