...
#ifdef _SIKKFB
// sikk - Make "feedback" the default "fs_game_base" path
idCVar  idFileSystemLocal::fs_game_base( "fs_game_base", "feedback", CVAR_SYSTEM | CVAR_INIT | CVAR_SERVERINFO, "alternate mod path, searched after the main fs_game path, before the basedir" );
#else
