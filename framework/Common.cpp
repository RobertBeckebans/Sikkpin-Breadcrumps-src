...
idCVar com_allowConsole( "com_allowConsole", "1", CVAR_BOOL | CVAR_SYSTEM | CVAR_NOCHEAT, "allow toggling console with the tilde key" );	// sikk - default to 1
...
//	session->WriteCDKey( );	// sikk - CDKey Removed
...
void Com_ExecMachineSpec_f( const idCmdArgs &args ) {
	if ( com_machineSpec.GetInteger() == 3 ) {
		...
		cvarSystem->SetCVarInteger( "image_roundDown", 0, CVAR_ARCHIVE );
...
//		cvarSystem->SetCVarInteger( "image_anisotropy", 8, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify anisotropic filtering
//		cvarSystem->SetCVarInteger( "r_mode", 5, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify resolution
//		cvarSystem->SetCVarInteger( "r_multiSamples", 0, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify aa
...
//		cvarSystem->SetCVarInteger( "image_anisotropy", 8, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify anisotropic filtering
//		cvarSystem->SetCVarInteger( "r_mode", 4, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify resolution
//		cvarSystem->SetCVarInteger( "r_multiSamples", 0, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify aa
		cvarSystem->SetCVarInteger( "s_maxSoundsPerShader", 0, CVAR_ARCHIVE );
		...
		cvarSystem->SetCVarInteger( "image_usePrecompressedTextures", 1, CVAR_ARCHIVE );
//		cvarSystem->SetCVarInteger( "image_anisotropy", 0, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify anisotropic filtering
//		cvarSystem->SetCVarInteger( "r_mode", 3, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify resolution
//		cvarSystem->SetCVarInteger( "r_multiSamples", 0, CVAR_ARCHIVE );	// sikk - Quality setting shouldn't modify aa
		cvarSystem->SetCVarInteger( "s_maxSoundsPerShader", 8, CVAR_ARCHIVE );
	} else {
		...
		cvarSystem->SetCVarInteger( "image_lodbias", 0, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_roundDown", 1, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_preload", 0, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_useAllFormats", 1, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_useCompression", 1, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_useNormalCompression", 2, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_usePrecompressedTextures", 1, CVAR_ARCHIVE );
...
// sikk - Fix for negative vram values
	if ( idMath::Abs( Sys_GetVideoRam() ) < 128 ) {
...
// sikk - Fix for negative vram values
	if ( idMath::Abs( Sys_GetVideoRam() ) < 512 ) {
		cvarSystem->SetCVarBool( "image_ignoreHighQuality", true, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "s_maxSoundsPerShader", 1, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_downSize", 1, CVAR_ARCHIVE );
		cvarSystem->SetCVarInteger( "image_downSizeLimit", 256, CVAR_ARCHIVE );
...
//	renderSystem->DrawSmallStringExt( ( 640 - len * SMALLCHAR_WIDTH ) / 2, 410, msg, idVec4( 0.0f, 0.81f, 0.94f, 1.0f ), true, declManager->FindMaterial( "textures/bigchars" ) );
	renderSystem->DrawSmallStringExt( ( 640 - len * SMALLCHAR_WIDTH ) / 2, 410, msg, idVec4( 0.1f, 0.1f, 0.1f, 0.5f ), true, declManager->FindMaterial( "textures/bigchars" ) );
...
//	idSIMD::InitProcessor( "doom", com_forceGenericSIMD.GetBool() );
	idSIMD::InitProcessor( "feedback", com_forceGenericSIMD.GetBool() );	// sikk - 
...
// sikk - Fix for negative vram values
	int vidRam = idMath::Abs( Sys_GetVideoRam() );
