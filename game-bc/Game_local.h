...
#define	GAME_VERSION		"baseFeedback-1"	// sikk - was "baseDOOM-1"
...
public:
	...
	int						numCrumbs;	// sikk - Crumb count
//	int						monsters;	// sikk - Monster Count
	idList<idAI *>			monsters;	// sikk - Monster Count

// ---> sikk - target_endlevel position
	float					endLevelRadius[4];
	idVec3					endLevelPos[4];
// <--- sikk - target_endlevel position

// ---> sikk - Hitscan
	idEntity*				HitScan( const idDict& hitscanDef, const idVec3& origin, const idVec3& dir, const idVec3& fxOrigin, idEntity* owner = NULL, bool noFX = false, float damageScale = 1.0f );
// <--- sikk - Hitscan
...
// <--- sikk - Portal Sky Box
	...
	idStaticList<spawnSpot_t, MAX_GENTITIES>*	GetSpawnSpots( void ) { return &spawnSpots; };
...
//
typedef enum gameSoundChannel_e {
...
#include "AFEntity.h"
#include "Misc.h"
#include "Spawner.h"				// sikk - func_spawner
#include "Actor.h"
