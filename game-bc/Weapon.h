...
// ---> sikk - Railgun Beam
	...
	qhandle_t				railbeamModelDefHandle;
	int						railbeamTime;
	bool					railType;
	idEntityFx* 			railbeamFX;
	//idEntityPtr<idEntityFx>*	railbeamFX
// <--- sikk - Railgun Beam
...
private:
	// script control
	idScriptBool			WEAPON_PRIMARY;		// sikk - Primary Attack
	idScriptBool			WEAPON_SECONDARY;	// sikk - Secondary Attack
...
// sikk - removed multiplayer
	...
	idDict					projectileSecDict;	// sikk - Secondary Fire
	float					meleeDistance;
	idStr					meleeDefName;
	idDict					brassDict;
	int						brassDelay;
...
// ---> sikk - Secondary Fire
	int						muzzle_kick_time_sec;
	int						muzzle_kick_maxtime_sec;
	idAngles				muzzle_kick_angles_sec;
	idVec3					muzzle_kick_offset_sec;
// <--- sikk - Secondary Fire
