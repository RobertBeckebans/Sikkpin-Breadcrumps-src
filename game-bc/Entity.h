...
extern const idEventDef EV_FadeSound;	// sikk - Added
...
// ---> sikk - Added: These are identical but return the length of the sound file
	int						StartSoundLength( const char *soundName, const s_channelType channel, int soundShaderFlags, bool broadcast, int *length );
	int						StartSoundShaderLength( const idSoundShader *shader, const s_channelType channel, int soundShaderFlags, bool broadcast, int *length );
// <--- sikk - Added: These are identical but return the length of the sound file
...
// ---> sikk - Level Music
	void					FadeSound( int channel, float to, float over ) { if ( refSound.referenceSound ) { refSound.referenceSound->FadeSound( channel, to, over ); }; }
// <--- sikk - Level Music
