...
public:
	...
	void				SetTargetPostFX( const char *mtr, idVec4 color ) { targetPostFxMtr = mtr; targetPostFxColor = color; };	// sikk - Target Post FX
...
// ---> sikk - PostProcess Effects
	...
	void				PostFX_SSAO( const renderView_t *view );
	...
	void				PostFX_TargetPostFX( void );	// sikk - Target Post FX

	void				PostFX_ThreatLevelFX( void );	// sikk - Threat Level FX
	...
	//const idMaterial *	hdrLumMaterial;			// HDR Luminance Base material
	...
	const idMaterial *	threatFOVMaterial;		// Threat Level FOV material
	const idMaterial *	threatProxMaterial;		// Threat Level Proximity material
	const idMaterial *	threatPulseMaterial;	// Threat Level Pulse material
	...
	bool				clearSSAO;				// Holds whether we need to clear the _ssao image

	const char *		targetPostFxMtr;
	idVec4				targetPostFxColor;
// <--- sikk - PostProcess Effects
};
