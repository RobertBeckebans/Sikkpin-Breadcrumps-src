...
public:
	...
	virtual void			FreeLightDef( void );	// sikk - Crumb Light
...
public:
	...
	static void				DropRandomItems( idAnimatedEntity *ent, const char *type, idList<idEntity *> *list );	// sikk - Random Item Drops
