...
// default scripts
#define SCRIPT_DEFAULTDEFS			"script/script_defs.script"	//"script/doom_defs.script"	// sikk - Renamed
#define SCRIPT_DEFAULT				"script/script_main.script"	//"script/doom_main.script"	// sikk - Renamed
#define SCRIPT_DEFAULTFUNC			"script_main"				//"doom_main"				// sikk - Renamed

typedef struct gameReturn_s {
