...
class idSpawner;	// sikk - func_spawner
...
// ---> sikk - func_spawner
	void					SetSpawner( idSpawner* _spawner ) { spawner = _spawner; }
	idSpawner*				GetSpawner( void ) { return spawner.GetEntity(); };
	idEntityPtr<idSpawner>	spawner;
// <--- sikk - func_spawner

	void					UpdateIncendiaryParticle( int state ) { Event_SetSmokeVisibility( 0, state ); }
